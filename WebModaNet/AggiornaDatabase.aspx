<%@ Page Title='<%$ Resources: Resources, AggiornaDatabase %>' Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AggiornaDatabase.aspx.cs" Inherits="EW.WebModaNet.AggiornaDatabase" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="aggiornaDatabase">
        <asp:Literal ID="TitoloLiteral" Text='<%$ Resources: Resources, AggiornaDatabase %>' runat="server"></asp:Literal>
    </h2>

    <p id="databaseGiaAggiornato" class="info" enableviewstate="false" visible="false" runat="server">
        <asp:Literal ID="DatabaseGiaAggiornatoLiteral" Text='<%$ Resources: Resources, DatabaseGiaAggiornato %>' runat="server"></asp:Literal>
    </p>

    <asp:Panel ID="DownloadPanel" runat="server">
        <p class="info">
            <asp:Literal ID="IstruzioniDownloadLiteral" Text='<%$ Resources: Resources, IstruzioniDownloadDB %>' runat="server"></asp:Literal>
        </p>
        ...
        <asp:UpdatePanel ID="DownloadUpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <p id="downloadInfoMessage" class="info" enableviewstate="false" visible="false" runat="server">
                    <asp:Literal ID="DownloadInfoMessageLiteral" Text='<%$ Resources: Resources, NessunAggiornamentoDisponibile %>' runat="server"></asp:Literal>
                </p>
