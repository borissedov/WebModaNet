<%@ Page Title='<%$ Resources: Resources, AggiornaImmagini %>' Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AggiornaImmagini.aspx.cs" Inherits="EW.WebModaNet.AggiornaImmagini" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="aggiornaImmagini">
        <asp:Literal ID="AggiornaImmaginiLiteral" Text='<%$ Resources: Resources, AggiornaImmagini %>' runat="server"></asp:Literal>
    </h2>

    <asp:Panel ID="DownloadPanel" runat="server">
        <p class="info">
            <asp:Literal ID="IstruzioniDownloadLiteral" Text='<%$ Resources: Resources, IstruzioniDownloadImmagini %>' runat="server"></asp:Literal>
        </p>
